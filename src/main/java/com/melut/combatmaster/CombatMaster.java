...
import com.melut.combatmaster.commands.LeaderboardCommand;
...
public class CombatMaster extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("combatmaster").setExecutor(new CombatMasterCommand(this, configManager));
        getCommand("leaderboard").setExecutor(new LeaderboardCommand(this, databaseManager));
