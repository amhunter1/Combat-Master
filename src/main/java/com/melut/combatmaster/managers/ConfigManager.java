...
public class ConfigManager {
    ...
    public SoundConfig getMissSound() {
        return config.getBoolean("sounds.miss-sound.enabled", true) ? 
            getSoundConfig("sounds.miss-sound") : null;
    }
    ...
    // Miss sistemi ayarları
    public boolean isMissSystemEnabled() {
        return config.getBoolean("combo.miss-system.enabled", true);
    }
    
    public boolean shouldResetOnMiss() {
        return config.getBoolean("combo.miss-system.reset-on-miss", true);
    }
