...
public class DatabaseManager {
    ...
    private void setupDataSource() {
        ...
        if (databaseType.equals("mysql")) {
            ...
            config.setJdbcUrl("jdbc:sqlite:" + dataFolder.getAbsolutePath() + "/combatmaster.db");
    ...
    private void createTables() throws SQLException {
        ...
        String createIndex = "CREATE INDEX IF NOT EXISTS idx_best_combo ON combat_players(best_combo DESC)";
        try (Connection conn = getConnection();
